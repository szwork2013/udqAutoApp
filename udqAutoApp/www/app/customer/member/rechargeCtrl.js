angular.module('udqApp')
    .controller('customerRechargeCtrl', ['$scope', '$window', '$ionicHistory', '$state', 'customerMemberInfoSvr', 'popUpSvr', function ($scope, $window, $ionicHistory, $state, customerMemberInfoSvr, popUpSvr) {
        $scope.balance = {
